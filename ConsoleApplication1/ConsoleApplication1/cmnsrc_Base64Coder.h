// cmnsrc_Base64Coder.h: interface for the Base64Coder class.
//
//////////////////////////////////////////////////////////////////////
...
#define	BASED64_HEADER _T(" !BASE64ED! ")
...
public:
	...
	virtual DWORD	DecodeLen() const { return m_nDBufLen; }
	virtual DWORD	DecodedDataLen() const { return m_nValidDDataLen; }

...
# if defined(JSON_HAS_INT64)
   std::wstring JSON_API valueToString( Int value );
   std::wstring JSON_API valueToString( UInt value );
# endif // if defined(JSON_HAS_INT64)
   std::wstring JSON_API valueToString( LargestInt value );
   std::wstring JSON_API valueToString( LargestUInt value );
   std::wstring JSON_API valueToString( double value );
   std::wstring JSON_API valueToString( bool value );
   std::wstring JSON_API valueToQuotedString( const wchar_t *value );
